<?php
/*
 * This flie belongs to Pydio. For this Typo3 extension, the function
 * typo3_remote_auth was added. It is stored within the extension
 * just for reference. To make it work, it must be located in the 
 * Pydio installation in plugin auth.remote.
 *
 *
 ...
 * @return array|string
 */
function typo3_remote_auth($host, $uri, $login, $pass, $formId = "")
{
    require_once(AJXP_BIN_FOLDER."/lib/HttpClient.php");

	// Variables seems to be wrong, hence a specific setting hard-coded
	$host = 'https://www.fku.ch';
	$uri = '/home/';
	...
	if ($headers['content-encoding'] == 'gzip') {
	    $content = gzdecode($client->getContent());
	}
    $xmlDoc = new DOMDocument();
